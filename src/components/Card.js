...
const Card = ({ movie }) => {
  ...
  return (
    <div onClick={() => history.push(`/movie/${movie.id}`)} className="group animate-loading-fade w-52 h-96 flex flex-col bg-gray-100 hover:bg-gray-200 rounded-md my-5 mx-2 p-3 transition-colors cursor-pointer shadow-md">
